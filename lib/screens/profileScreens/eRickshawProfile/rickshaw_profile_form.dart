...
class RickshawProfileForm extends StatefulWidget {
  final MyProfileData? profile;
  final VoidCallback onUpdate;

  const RickshawProfileForm({
    super.key,
  ...
  @override
  State<RickshawProfileForm> createState() => _RickshawProfileFormState();
}

class _RickshawProfileFormState extends State<RickshawProfileForm> {
