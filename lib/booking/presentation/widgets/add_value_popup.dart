...
class AddValuePopup extends StatefulWidget {
  final void Function(String type) listener;

  const AddValuePopup({required this.listener, super.key});

  @override
  State<AddValuePopup> createState() => _AddValuePopupState();
}

class _AddValuePopupState extends State<AddValuePopup> {
  ...
  String selectedMode = "Purpose 1";
  final modes = ["Purpose 1", "Purpose 2", "Purpose 3",];
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Add payment addition",
